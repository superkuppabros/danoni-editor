...
export const DefaultKeyConfig: KeyConfig = {
  ...
  "8": {
    ...
    chars: ["S", "D", "F", "G", "J", "K", "L", "+"],
    alternativeKeys: ["", "", "", "KeyH", "", "", "", ""],
    noteNames: ["left_data", "leftdia_data", "down_data", "space_data", "up_data", "rightdia_data", "right_data", "sleft_data"],
    freezeNames: [
      "frzLeft_data",
      "frzLdia_data",
      "frzDown_data",
  ...
  "9A": {
    id: 5,
    num: 9,
    keys: ["KeyS", "KeyD", "KeyE", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyI", "KeyL"],
  ...
  "9B": {
    id: 6,
    num: 9,
    keys: ["KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyL", "Semicolon"],
  ...
  "9d": {
    id: 7,
    num: 9,
    keys: ["KeyS", "KeyD", "KeyF", "KeyV", "KeyG", "KeyN", "KeyJ", "KeyK", "KeyL"],
    chars: ["S", "D", "F", "V", "G", "N", "J", "K", "L"],
    alternativeKeys: ["", "", "", "", "KeyH", "", "", "", ""],
    noteNames: [
      "left_data",
      "down_data",
    ...
    colorGroup: [0, 1, 0, 2, 2, 2, 0, 1, 0],
  },

  "9h": {
    id: 7,
    num: 9,
    keys: ["Digit1", "KeyA", "KeyZ", "KeyS", "KeyH", "KeyM", "KeyY", "KeyU", "KeyI"],
    chars: ["1", "A", "Z", "S", "H", "M", "Y", "U", "I"],
    alternativeKeys: ["", "", "", "", "", "", "", "", ""],
    noteNames: ["1x_data", "ax_data", "zx_data", "sx_data", "hx_data", "mx_data", "yx_data", "ux_data", "ix_data"],
    freezeNames: [
      "frz1x_data",
      "frzAx_data",
      "frzZx_data",
    ...
    colorGroup: [2, 1, 0, 1, 0, 0, 3, 3, 3],
  },

  "9i": {
    id: 7,
    num: 9,
    keys: ["KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyI", "KeyL"],
  ...
  "11L": {
    id: 9,
    num: 11,
    keys: ["KeyW", "KeyE", "Digit3", "KeyR", "KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyL"],
  ...
  "11W": {
    id: 10,
    num: 11,
    keys: ["KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyL", "Digit2", "KeyT", "KeyY", "Digit0"],
    chars: ["S", "D", "F", "G", "J", "K", "L", "2", "T", "Y", "0"],
    alternativeKeys: ["", "", "", "KeyH", "", "", "", "Digit1", "", "", "Minus"],
    noteNames: [
      "left_data",
      "leftdia_data",
      "down_data",
  ...
  "11i": {
    id: 11,
    num: 11,
    keys: ["KeyS", "KeyC", "KeyD", "KeyE", "KeyF", "KeyG", "KeyJ", "KeyM", "KeyK", "KeyI", "KeyL"],
    chars: ["S", "C", "D", "E", "F", "G", "J", "M", "K", "I", "L"],
    alternativeKeys: ["", "KeyX", "", "KeyR", "", "KeyH", "", "Comma", "", "KeyO", ""],
    noteNames: [
      "left_data",
      "down_data",
      "gor_data",
  ...
  "11j": {
    id: 11,
    num: 11,
    keys: ["KeyA", "KeyS", "KeyD", "KeyE", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyI", "KeyL", "Semicolon"],
    chars: ["A", "S", "D", "E", "F", "G", "J", "K", "I", "L", "+"],
    alternativeKeys: ["", "", "", "KeyR", "", "KeyH", "", "", "KeyO", "", ""],
    noteNames: [
      "gor_data",
      "left_data",
    ...
    colorGroup: [2, 0, 0, 0, 0, 2, 1, 1, 1, 1, 2],
  },

  "12": {
    id: 12,
    num: 12,
    keys: ["KeyG", "KeyN", "KeyJ", "KeyM", "KeyK", "Comma", "KeyL", "Period", "KeyU", "KeyI", "Digit8", "KeyO"],
  ...
  "12i": {
    ...
    chars: ["F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9", "F10", "F11", "F12"],
    alternativeKeys: [
      "KeyQ",
      "KeyW",
      "KeyE",
    ...
    colorGroup: [0, 0, 0, 0, 2, 2, 2, 2, 1, 1, 1, 1],
  },

  "13": {
    id: 13,
    num: 13,
    keys: ["KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyL", "Semicolon", "KeyU", "KeyI", "Digit8", "KeyO"],
  ...
  "14": {
    id: 14,
    num: 14,
    keys: ["KeyG", "KeyN", "KeyJ", "KeyM", "KeyK", "Comma", "KeyL", "Period", "KeyY", "KeyU", "KeyI", "Digit8", "KeyO", "KeyP"],
    chars: ["G", "N", "J", "M", "K", "<", "L", ">", "Y", "U", "I", "8", "O", "P"],
    alternativeKeys: ["KeyH", "", "", "", "", "", "", "", "KeyT", "", "", "Digit9", "", "BracketLeft"],
    noteNames: [
      "oni_data",
      "left_data",
      "leftdia_data",
  ...
  "14i": {
    id: 15,
    num: 14,
    keys: ["KeyZ", "KeyX", "KeyC", "KeyS", "KeyD", "KeyF", "KeyG", "KeyJ", "KeyK", "KeyL", "KeyU", "KeyI", "Digit8", "KeyO"],
    chars: ["Z", "X", "C", "S", "D", "F", "G", "J", "K", "L", "U", "I", "8", "O"],
    alternativeKeys: ["", "", "", "", "", "", "KeyH", "", "", "", "", "", "Digit9", ""],
    noteNames: [
      "gor_data",
      "space_data",
  ...
  "15": {
    ...
    chars: ["W", "E", "3", "R", "S", "D", "F", "G", "J", "K", "L", "U", "I", "8", "O"],
  ...
  "16i": {
    ...
    chars: ["Z", "X", "C", "A", "S", "D", "F", "G", "J", "K", "L", "+", "U", "I", "8", "O"],
    alternativeKeys: ["", "", "", "", "", "", "", "KeyH", "", "", "", "", "", "", "Digit9", ""],
    noteNames: [
      "gor_data",
      "space_data",
  ...
  "17": {
    ...
    chars: ["A", "Z", "S", "X", "D", "C", "F", "V", "G", "N", "J", "M", "K", "<", "L", ">", "+"],
    alternativeKeys: ["", "", "", "", "", "", "", "", "KeyH"],
    noteNames: [
      "aleft_data",
      "bleft_data",
  ...
  "23": {
    ...
    chars: ["W", "E", "3", "R", "Z", "S", "X", "D", "C", "F", "V", "G", "N", "J", "M", "K", "<", "L", ">", "U", "I", "8", "O"],
    alternativeKeys: ["", "", "Digit4", "", "", "", "", "", "", "", "", "KeyH", "", "", "", "", "", "", "", "", "", "Digit9", ""],
    noteNames: [
      "aleft_data",
      "adown_data",
    ...
    colorGroup: [3, 3, 3, 3, 0, 1, 0, 1, 0, 1, 0, 2, 0, 1, 0, 1, 0, 1, 0, 3, 3, 3, 3],
  },
};
